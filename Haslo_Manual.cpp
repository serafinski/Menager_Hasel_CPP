 ...
 */
void Haslo_Manual::showCategory_Manual(string sciezka_zewnetrzna_kategorie){
 ...
 * @param sciezka_zewnetrzna_kategorie - adres ścieżki zewnętrznej prowadzącej do kategorii. Potrzebna do manipulowania danymi użytkownika.
 */
void Haslo_Manual::addCategory_Manual(string sciezka_zewnetrzna_kategorie){
    string nazwasciezki;
 ...
 */
void Haslo_Manual::removeCategory_Manual(string sciezka_zewnetrzna_kategorie,string nazwa){
    string nazwasciezki;
    string nazwasciezkinazwy;
    string nazwasciezkilogin;
    string nazwasciezkihaslo;
 ...
 * @param sciezka_zewnetrzna_kategorie - adres ścieżki zewnętrznej prowadzącej do kategorii. Potrzebna do manipulowania danymi użytkownika.
 */
void Haslo_Manual::deleteaccount_Manual(string sciezka_zewnetrzna_hint,
 ...
 */
void Haslo_Manual::addname_Manual(string sciezka_zewnetrzna_kategorie,string nazwakategorii, string nazwahasla){
    string sciezka;
 ...
 */
void Haslo_Manual::addlogin_Manual(string sciezka_zewnetrzna_kategorie, string nazwakategorii, string login){
    string sciezka;
 ...
 */
void Haslo_Manual::addpassword_Manual(string sciezka_zewnetrzna_kategorie,string nazwakategorii, string haslo){
    string sciezka;
 ...
 */
void Haslo_Manual::addwww_Manual(string sciezka_zewnetrzna_kategorie,string nazwakategorii, string www){
    string sciezka;
 ...
 * @param nazwakategorii - informacja o nazwie kategorii. Potrzebna do manipulowania danymi użytkownika.
 */
void Haslo_Manual::showcategorycontents_Manual(string sciezka_zewnetrzna_kategorie,string nazwakategorii){
    int nr = 1;
    string sciezka;
    sciezka = sciezka_zewnetrzna_kategorie;
 ...
 */
void Haslo_Manual::deletename_Manual(string sciezka_zewnetrzna_kategorie, string nazwakategorii, unsigned int nr){
    string sciezka;
 ...
 * @param nr - wybrany numer hasła do usunięcia
 */
void Haslo_Manual::deletelogin_Manual(string sciezka_zewnetrzna_kategorie, string nazwakategorii, unsigned int nr){
    string sciezka;
 ...
 * @param nr - wybrany numer hasła do usunięcia
 */
void Haslo_Manual::deletepassword_Manual(string sciezka_zewnetrzna_kategorie, string nazwakategorii, unsigned int nr){
    string sciezka;
 ...
 */
void Haslo_Manual::deletewww_Manual(string sciezka_zewnetrzna_kategorie, string nazwakategorii, unsigned int nr){
    string sciezka;
 ...
 * @return zwróć plik
 */
std::fstream& Haslo_Manual::GotoLineManual(std::fstream& file, unsigned int num){
 ...
 */
void Haslo_Manual::getline_Manual(string sciezka_zewnetrzna_kategorie, string nazwakategorii, unsigned int nr){
    string sciezka;
    ...
    file >> Haslo_Manual::liniadousunieciamanual;
    cin.get();
}
 ...
 */
void Haslo_Manual::printpassword_Manual(){
    cout<<"\nZmieniane haslo:" << Haslo_Manual::liniadousunieciamanual << endl;
}
 ...
 */
void Haslo_Manual::changepassword_Manual(string sciezka_zewnetrzna_kategorie,string nazwakategorii, string nowehaslo){
    string sciezka;
    string starehaslo = Haslo_Manual::liniadousunieciamanual;
 ...
 * @param sciezka_zewnetrzna_kategorie - adres ścieżki zewnętrznej prowadzącej do kategorii. Potrzebna do manipulowania danymi użytkownika.
 */
void Haslo_Manual::concatnamefiles_Manual(string sciezka_zewnetrzna_kategorie){
    string nazwasciezki = sciezka_zewnetrzna_kategorie;
 ...
 * @param sciezka_zewnetrzna_kategorie - adres ścieżki zewnętrznej prowadzącej do kategorii. Potrzebna do manipulowania danymi użytkownika.
 */
void Haslo_Manual::concatloginfiles_Manual(string sciezka_zewnetrzna_kategorie){
    string nazwasciezki = sciezka_zewnetrzna_kategorie;
    string nazwaconcat =sciezka_zewnetrzna_kategorie;
 ...
 * @param sciezka_zewnetrzna_kategorie - adres ścieżki zewnętrznej prowadzącej do kategorii. Potrzebna do manipulowania danymi użytkownika.
 */
void Haslo_Manual::concatpasswordsfiles_Manual(string sciezka_zewnetrzna_kategorie){
    string nazwasciezki = sciezka_zewnetrzna_kategorie;
    string nazwaconcat =sciezka_zewnetrzna_kategorie;
 ...
 * @param sciezka_zewnetrzna_kategorie - adres ścieżki zewnętrznej prowadzącej do kategorii. Potrzebna do manipulowania danymi użytkownika.
 */
void Haslo_Manual::concatwwwfiles_Manual(string sciezka_zewnetrzna_kategorie){
    string nazwasciezki = sciezka_zewnetrzna_kategorie;
    string nazwaconcat =sciezka_zewnetrzna_kategorie;
 ...
 * @param sciezka_zewnetrzna_kategorie - adres ścieżki zewnętrznej prowadzącej do kategorii. Potrzebna do manipulowania danymi użytkownika.
 */
void Haslo_Manual::concatall_Manual(string sciezka_zewnetrzna_kategorie){
 ...
 * @param sciezka_zewnetrzna_kategorie - adres ścieżki zewnętrznej prowadzącej do kategorii. Potrzebna do manipulowania danymi użytkownika.
 */
void Haslo_Manual::sortnamesalphabet_Manual(string sciezka_zewnetrzna_kategorie){
 ...
 * @param sciezka_zewnetrzna_kategorie - adres ścieżki zewnętrznej prowadzącej do kategorii. Potrzebna do manipulowania danymi użytkownika.
 */
void Haslo_Manual::sortloginsalphabet_Manual(string sciezka_zewnetrzna_kategorie){
    std::vector<string> names;
    string nazwaconcat;
 ...
 * @param sciezka_zewnetrzna_kategorie - adres ścieżki zewnętrznej prowadzącej do kategorii. Potrzebna do manipulowania danymi użytkownika.
 */
void Haslo_Manual::sortpasswordsalphabet_Manual(string sciezka_zewnetrzna_kategorie){
    std::vector<string> names;
    string nazwaconcat;
 ...
 * @param sciezka_zewnetrzna_kategorie - adres ścieżki zewnętrznej prowadzącej do kategorii. Potrzebna do manipulowania danymi użytkownika.
 */
void Haslo_Manual::sortwwwalphabet_Manual(string sciezka_zewnetrzna_kategorie){
    std::vector<string> names;
    string nazwaconcat;
