 ...
 */
void haslo::readpassword(string sciezka,string password){
    fstream fileIn;
 ...
 */
bool haslo::confirmdeletion(string sciezka,string password){
    fstream fileIn;
    fileIn.open(sciezka,std::ios::in);
 ...
 */
void haslo::wyswietlpodpowiedz(string sciezka){
    char odp;
 ...
 */
void haslo::showCategory(string imie_login){
    string nazwasciezki;
    nazwasciezki.append("../");
 ...
 * @param imie_login - informacja o nazwie użytkownika. Potrzebna do manipulowania danymi użytkownika.
 */
void haslo::addCategory(string imie_login){
    string nazwasciezki;
 ...
 */
void haslo::removeCategory(string imie_login,string nazwa){
    string nazwasciezki;
    string nazwasciezkinazwy;
    string nazwasciezkilogin;
    string nazwasciezkihaslo;
 ...
 */
void haslo::overwritetimestampnewuser(){
    time_t czas = time(0);
 ...
 * @param imie_login - informacja o nazwie użytkownika. Potrzebna do manipulowania danymi użytkownika.
 */
void haslo::overwritetimestamp(string imie_login){
    time_t czas = time(0);
    char* timestamp = ctime(&czas);
 ...
 */
void haslo::overwritetimestampmanual(string sciezka){
    time_t czas = time(0);
    char* timestamp = ctime(&czas);
 ...
 * @param imie_login - informacja o nazwie użytkownika. Potrzebna do manipulowania danymi użytkownika.
 */
void haslo::readtimestamp(string imie_login){
 ...
 */
void haslo::readtimestampmanual(string sciezka){
 ...
 * @param imie_login - informacja o nazwie użytkownika. Potrzebna do manipulowania danymi użytkownika.
 */
void haslo::deleteaccount(string imie_login){
    string sciezka;
 ...
 */
void haslo::addname(string imie_login,string nazwakategorii, string nazwahasla){
    string sciezka;
 ...
 */
void haslo::addlogin(string imie_login, string nazwakategorii, string login){
    string sciezka;
 ...
 */
void haslo::addpassword(string imie_login,string nazwakategorii, string haslo){
    string sciezka;
 ...
 */
void haslo::addwww(string imie_login,string nazwakategorii, string www){
    string sciezka;
 ...
 * @param nazwakategorii - informacja o nazwie kategorii. Potrzebna do manipulowania danymi użytkownika.
 */
void haslo::showcategorycontents(string imie_login,string nazwakategorii){
    int nr = 1;
    string sciezka;
    sciezka.append("../");
    sciezka.append(imie_login);
 ...
 */
void haslo::deletename(string imie_login, string nazwakategorii, unsigned int nr){
    string sciezka;
 ...
 * @param nr - wybrany numer hasła do usunięcia
 */
void haslo::deletelogin(string imie_login, string nazwakategorii, unsigned int nr){
    string sciezka;
 ...
 * @param nr - wybrany numer hasła do usunięcia
 */
void haslo::deletepassword(string imie_login, string nazwakategorii, unsigned int nr){
    string sciezka;
 ...
 */
void haslo::deletewww(string imie_login, string nazwakategorii, unsigned int nr){
    string sciezka;
 ...
 * @return zwróć plik
 */
std::fstream& haslo::GotoLine(std::fstream& file, unsigned int num){
 ...
 */
void haslo::getline(string imie_login, string nazwakategorii, unsigned int nr){
    string sciezka;
 ...
 */
void haslo::changepassword(string imie_login,string nazwakategorii, string nowehaslo){
    string sciezka;
 ...
 * @param imie_login - informacja o nazwie użytkownika. Potrzebna do manipulowania danymi użytkownika.
 */
void haslo::concatnamefiles(string imie_login){
    string nazwasciezki;
    string nazwaconcat;
    ...
    for (const auto & entry : std::filesystem::directory_iterator(nazwasciezki)){
        ...
        if(element.is_open()){
            string line;
            while (std::getline(element,line)){
                concat << line << endl;
            }
            element.close();
        }
 ...
 * @param imie_login - informacja o nazwie użytkownika. Potrzebna do manipulowania danymi użytkownika.
 */
void haslo::concatloginfiles(string imie_login){
    string nazwasciezki;
    string nazwaconcat;
 ...
 * @param imie_login - informacja o nazwie użytkownika. Potrzebna do manipulowania danymi użytkownika.
 */
void haslo::concatpasswordsfiles(string imie_login){
    string nazwasciezki;
    string nazwaconcat;
 ...
 * @param imie_login - informacja o nazwie użytkownika. Potrzebna do manipulowania danymi użytkownika.
 */
void haslo::concatwwwfiles(string imie_login){
    string nazwasciezki;
    string nazwaconcat;
 ...
 * @param imie_login - informacja o nazwie użytkownika. Potrzebna do manipulowania danymi użytkownika.
 */
void haslo::concatall(string imie_login){
 ...
 * @param imie_login - informacja o nazwie użytkownika. Potrzebna do manipulowania danymi użytkownika.
 */
void haslo::sortnamesalphabet(string imie_login){
 ...
 * @param imie_login - informacja o nazwie użytkownika. Potrzebna do manipulowania danymi użytkownika.
 */
void haslo::sortloginsalphabet(string imie_login){
    std::vector<string> names;
    string nazwaconcat;
 ...
 * @param imie_login - informacja o nazwie użytkownika. Potrzebna do manipulowania danymi użytkownika.
 */
void haslo::sortpasswordsalphabet(string imie_login){
    std::vector<string> names;
    string nazwaconcat;
 ...
 * @param imie_login - informacja o nazwie użytkownika. Potrzebna do manipulowania danymi użytkownika.
 */
void haslo::sortwwwalphabet(string imie_login){
    std::vector<string> names;
    string nazwaconcat;
